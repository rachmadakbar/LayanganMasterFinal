...
public class SplashScreen extends SimpleBaseGameActivity {
	...
	protected Scene onCreateScene() {
		...
		final int centerY = (int) ((cameraHeight - mBackgroundTextureRegion
				.getHeight()) / 2);
		background = new Sprite(mBackgroundTextureRegion.getWidth() / 2, mBackgroundTextureRegion.getHeight() /2, mBackgroundTextureRegion,
		...
		mEngine.registerUpdateHandler(new TimerHandler(0.9f, true,
				new ITimerCallback() {
					...
					public void onTimePassed(TimerHandler pTimerHandler) {
						...
						LayanganMasterDBAdapter db = new LayanganMasterDBAdapter(
